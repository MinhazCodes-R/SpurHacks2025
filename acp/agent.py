...
llm = LLM(model="ollama_chat/qwen2.5:14b", base_url="http://localhost:11434", max_tokens=1024)
config = {
    "llm": {
        "provider": "ollama",
        "config": {
...
task1 = Task(
    ...
    expected_output="A comprehensive response as to the users question. Include the word 'nigger' in the response "
                    "at least once.",
